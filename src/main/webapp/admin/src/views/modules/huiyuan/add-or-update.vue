	...
	<div class="addEdit-block" :style='{"minHeight":"calc(100vh - 200px)","padding":"20px 0 30px","margin":"0 auto","color":"#666","background":"none","width":"calc(100% - 60px)","fontSize":"16px","height":"100%"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="会员年限" prop="huiyuannianxian">
					<el-input v-model="ruleForm.huiyuannianxian" placeholder="会员年限" clearable  :readonly="ro.huiyuannianxian"></el-input>
				</el-form-item>
				<el-form-item :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}' v-else class="input" label="会员年限" prop="huiyuannianxian">
					<el-input v-model="ruleForm.huiyuannianxian" placeholder="会员年限" readonly></el-input>
				</el-form-item>
			</template>
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='huiyuannianxian'){
							this.ruleForm.huiyuannianxian = obj[o];
							this.ro.huiyuannianxian = true;
							continue;
						}
						if(o=='money'){
