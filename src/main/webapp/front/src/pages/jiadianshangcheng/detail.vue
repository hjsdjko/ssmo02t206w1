...
<div>
	<div :style='{"padding":"20px","margin":"10px auto","borderRadius":"0","background":"rgba(255, 150, 27, 0.50)","display":"flex","width":"80%","justifyContent":"center"}' class="breadcrumb-preview">
		<el-breadcrumb :separator="'>'" :style='{"fontSize":"14px","lineHeight":"1"}'>
			...
			<el-breadcrumb-item class="item2" v-for="(item, index) in breadcrumbItem" :key="index" :to="'/index/jiadianshangcheng?centerType=' + (centerType?'1':'0')"><a>{{item.name}}</a></el-breadcrumb-item>
	...
	<div class="detail-preview" :style='{"width":"100%","padding":"0 14%","margin":"10px auto","position":"relative","flexWrap":"wrap","display":"flex"}'>
		<div class="attr" :style='{"minHeight":"640px","padding":"0","flexWrap":"wrap","background":"#f5f5f5","display":"flex","width":"30%","position":"relative"}'>
			...
			<div class="info" :style='{"width":"100%","padding":"20px 10px","margin":"0","background":"#fff"}'>
				...
				<div class="item" :style='{"padding":"0 0","margin":"0 0 0 0","background":"none","justifyContent":"spaceBetween","display":"flex"}' v-if="detail.price">
					<div class="lable" :style='{"padding":"0 10px","color":"#999","textAlign":"left","width":"auto","fontSize":"12px","lineHeight":"40px","height":"40px"}'>价格</div>
					<div style="font-weight: bold;" :style='{"padding":"8px 10px 0","fontSize":"12px","lineHeight":"24px","color":"#666","flex":"1"}'><span :style='{"fontSize":"12px"}'>￥</span>{{detail.price}}</div>
				</div>
				<div class="item" :style='{"padding":"0 0","margin":"0 0 0 0","background":"none","justifyContent":"spaceBetween","display":"flex"}' v-if="detail.jf">
					<div class="lable" :style='{"padding":"0 10px","color":"#999","textAlign":"left","width":"auto","fontSize":"12px","lineHeight":"40px","height":"40px"}'>积分</div>
					<div style="color: red;font-weight: bold;" :style='{"padding":"8px 10px 0","fontSize":"12px","lineHeight":"24px","color":"#666","flex":"1"}'>{{detail.jf}}</div>
				</div>
				<div class="item" :style='{"padding":"0 0","margin":"0 0 0 0","background":"none","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#999","textAlign":"left","width":"auto","fontSize":"12px","lineHeight":"40px","height":"40px"}'>单限</div>
					<div :style='{"padding":"8px 10px 0","fontSize":"12px","lineHeight":"24px","color":"#666","flex":"1"}'>{{detail.onelimittimes}}</div>
				</div>
				<div class="item" :style='{"padding":"0 0","margin":"0 0 0 0","background":"none","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#999","textAlign":"left","width":"auto","fontSize":"12px","lineHeight":"40px","height":"40px"}'>库存</div>
					<div :style='{"padding":"8px 10px 0","fontSize":"12px","lineHeight":"24px","color":"#666","flex":"1"}'>{{detail.alllimittimes}}</div>
				</div>
				<div class="item" :style='{"padding":"0 0","margin":"0 0 0 0","background":"none","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#999","textAlign":"left","width":"auto","fontSize":"12px","lineHeight":"40px","height":"40px"}'>家电编号</div>
					<div  :style='{"padding":"8px 10px 0","fontSize":"12px","lineHeight":"24px","color":"#666","flex":"1"}'>{{detail.jiadianbianhao}}</div>
				</div>
				<div class="item" :style='{"padding":"0 0","margin":"0 0 0 0","background":"none","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#999","textAlign":"left","width":"auto","fontSize":"12px","lineHeight":"40px","height":"40px"}'>家电分类</div>
					<div  :style='{"padding":"8px 10px 0","fontSize":"12px","lineHeight":"24px","color":"#666","flex":"1"}'>{{detail.jiadianfenlei}}</div>
				</div>
				<div class="item" :style='{"padding":"0 0","margin":"0 0 0 0","background":"none","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#999","textAlign":"left","width":"auto","fontSize":"12px","lineHeight":"40px","height":"40px"}'>型号</div>
					<div  :style='{"padding":"8px 10px 0","fontSize":"12px","lineHeight":"24px","color":"#666","flex":"1"}'>{{detail.xinghao}}</div>
				</div>
				<div class="item" :style='{"padding":"0 0","margin":"0 0 0 0","background":"none","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#999","textAlign":"left","width":"auto","fontSize":"12px","lineHeight":"40px","height":"40px"}'>参数</div>
					<div  :style='{"padding":"8px 10px 0","fontSize":"12px","lineHeight":"24px","color":"#666","flex":"1"}'>{{detail.canshu}}</div>
				</div>
				<div class="item" :style='{"padding":"0 0","margin":"0 0 0 0","background":"none","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#999","textAlign":"left","width":"auto","fontSize":"12px","lineHeight":"40px","height":"40px"}'>品牌</div>
					<div  :style='{"padding":"8px 10px 0","fontSize":"12px","lineHeight":"24px","color":"#666","flex":"1"}'>{{detail.pinpai}}</div>
				</div>
				<div class="item" :style='{"padding":"0 0","margin":"0 0 0 0","background":"none","justifyContent":"spaceBetween","display":"flex"}'>
				...
				<div class="btn" :style='{"padding":"10px 0","flexWrap":"wrap","display":"flex"}'>
					<el-input-number :style='{"width":"40%","margin":"0 40% 10px 0","lineHeight":"38px","position":"relative","display":"inline-block","order":"1"}' v-if="detail.alllimittimes" :min=1 v-model="buynumber"></el-input-number>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"0 auto 10px","color":"#fff","outline":"none","borderRadius":"10px","background":"#FF961B","width":"49%","lineHeight":"40px","fontSize":"14px","height":"40px","order":"3"}' v-if="detail.alllimittimes" type="warning" size="small" @click="addCart">添加到购物车</el-button>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"0 auto 10px","color":"#fff","outline":"none","borderRadius":"10px","background":"linear-gradient(136deg, #F67055 0%, #FFC054 100%)","width":"100%","lineHeight":"40px","fontSize":"14px","height":"40px","order":"2"}' v-if="detail.alllimittimes" type="warning" size="small" @click="buyNow">立即购买</el-button>

				</div>
				<div class="btn" :style='{"padding":"10px 0","flexWrap":"wrap","display":"flex"}'>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"0 auto 10px","color":"#fff","outline":"none","borderRadius":"10px","background":"linear-gradient(136deg, #F67055 0%, #FFC054 100%)","width":"100%","lineHeight":"40px","fontSize":"14px","height":"40px","order":"2"}' v-if="btnAuth('jiadianshangcheng','修改')" @click="editClick">修改</el-button>
					<el-button :style='{"border":"1px solid #CCCCCC","cursor":"pointer","padding":"0 10px","margin":"0 auto 10px","color":"#CCCCCC","outline":"none","borderRadius":"10px","background":"none","width":"49%","lineHeight":"40px","fontSize":"14px","height":"40px","order":"6"}' v-if="btnAuth('jiadianshangcheng','删除')" @click="delClick">删除</el-button>
					<el-button :style='{"border":"1px solid #CCCCCC","cursor":"pointer","padding":"0 10px","margin":"0 auto 10px","color":"#CCCCCC","outline":"none","borderRadius":"10px","background":"none","width":"49%","lineHeight":"40px","fontSize":"14px","height":"40px","order":"6"}' v-if="btnAuth('jiadianshangcheng','私聊')&&detail.id!=mid" @click="chatClick">联系TA</el-button>
				</div>
			</div>
		</div>
		...
		<el-tabs class="detail" :style='{"border":"none","width":"100%","boxShadow":"none","background":"#FFF"}' v-model="activeName" type="border-card">
			<el-tab-pane label="家电详情" name="first">
				<div v-html="detail.jiadianxiangqing"></div>
			</el-tab-pane>
  ...
  export default {
    ...
    methods: {
          ...
          this.$http.get(this.tablename + '/detail/'  + this.id, {}).then(res => {
            if (res.data.code == 0) {
              this.detail = res.data.data;
				this.title = this.detail.jiadianmingcheng;
      ...
      storeup(type) {
        if (type == 1 && !this.isStoreup) {
          ...
          this.$http.post('storeup/add', this.storeupParams).then(res => {
            if (res.data.code == 0) {
			  ...
			  this.$http.post('jiadianshangcheng/update', this.detail).then(res => {});
              this.$message({
                type: 'success',
                message: '收藏成功!',
                duration: 1500,
        ...
        if (type == -1 && this.isStoreup) {
          this.$http.get('storeup/list', {params: {page: 1, limit: 1, type: 1, refid: this.detail.id, tablename: 'jiadianshangcheng', userid: localStorage.getItem('frontUserid')}}).then(res => {
      ...
      sizeChange(size){
		...
		backClick(){
			...
			this.$router.push({path: '/index/jiadianshangcheng', query: params});
		},
		// 下载
		download(file){
			if(!file) {
      ...
      getDiscussList(page) {
        this.$http.get('discussjiadianshangcheng/list', {params: {page, limit: this.pageSize, refid: this.detail.id}}).then(res => {
          if (res.data.code == 0) {
	  ...
	  discussDel(id){
		  this.$confirm('是否删除此评论？')
		    .then(_ => {
		      this.$http.post('discussjiadianshangcheng/delete',[id]).then(res=>{
            ...
            this.$http.get('orders/list', {params: {page: 1, limit: 1, status: '已完成', goodid: this.detail.id, userid: localStorage.getItem('frontUserid')}}).then(res => {
                if (res.data.code == 0 && res.data.data.list.length == 0) {
                  ...
                  return false
                    ...
                    this.$http.post('discussjiadianshangcheng/add', this.form).then(res => {
						if (res.data.code == 0) {
      ...
      getCartList() {
        this.$http.get('cart/list', {params: {userid: localStorage.getItem('frontUserid'), tablename: 'jiadianshangcheng', goodid: this.detail.id}}).then(res => {
          if (res.data.code == 0) {
      ...
      addCart() {
		...
		// 修改
		editClick(){
			this.$router.push(`/index/jiadianshangchengAdd?type=edit&&id=${this.detail.id}`);
		},
		// 删除
		async delClick(){
			await this.$confirm('是否删除此家电商城？')
			  .then(_ => {
			    this.$http.post('jiadianshangcheng/delete', [this.detail.id]).then(async res => {
					if (res.data.code == 0) {
